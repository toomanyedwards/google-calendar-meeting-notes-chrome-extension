            ...
            <Dialog  open={open}  aria-labelledby="form-dialog-title" fullWidth={true} maxWidth = {'xs'}>
                ...
                <DialogContent>
                    ...
                    <Box my={3}>
                        ...
                        <Tooltip title={notesDestinationInfo?notesDestinationInfo.treePath:"Choose a notes template document"}>
                            <TextField
                                id="notesDestination"
                                variant="outlined"
                                value={notesDestinationInfo?notesDestinationInfo.name:"Choose the notes document destination folder"}
                                fullWidth
                                InputProps={{
                                    readOnly: true,
                                }}
